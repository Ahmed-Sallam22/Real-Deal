          ...
          <div className="row ">
            <div className="col-xl-9 col-lg-8">
              ...
              <div className="property-details-slider-info">
                <h3><span>900,000 LE</span>The Wonder MarQ</h3>
                {/* <del>1,000,000 LE</del> */}
              </div>
              ...
              <div className="widget widget-owner-info mt-lg-0 mt-5">
                ...
                <div className="contact">
                  ...
                  <div className="rld-single-input">
                    <input type="text"  onChange={formik.handleChange} value={formik.values.Name} id='Name' placeholder="Full Name" />
                  </div>
                  <div className="rld-single-input">
                    <input type="text" onChange={formik.handleChange} value={formik.values.Email} placeholder="Email" id='Email' />
                  </div>
                  <div className="rld-single-input">
                    <input type="text" onChange={formik.handleChange} value={formik.values.Messages} placeholder="Messages" id='Messages'/>
                  </div>
                  <div className="rld-single-input">
                    <input type="tel" onChange={formik.handleChange} value={formik.values.Phone} placeholder="Phone" id='Phone'/>
                  </div>
                <button className='btn btn-outline-primary '>Send Messages</button>
                </form>
                </div>
                ...
                <div key={ i } className="col-lg-3 col-sm-6">
                  <div className="single-pricing text-center">
                    ...
                    <div className="details">
                      <h3 className="title">{ item.precentatge }OFF</h3>
                      <h5 className="title">Down Payment</h5>
                      <h5 className="price">{ item.DownPAyment }</h5>
                      <ul>
