                      ...
                      <div className="col-12 mb-3">
                        <div className="rld-single-select">
                          <select className="select single-select">
                            ...
                            <option value={2}>700.00 LE</option>
                            <option value={3}>$500.00 LE</option>
                            <option value={3}>$900.00 LE</option>
                          </select>
                        </div>
                      </div>
                      <div className="col-12 mb-3">
